...
GEMSPEC   = Gem::Specification.new do |gem|
	...
	gem.description       = [
		"This is a Ruby binding for the Verse network protocol. Verse a network ",
	...
	gem.homepage          = 'http://bitbucket.org/ged/ruby-verse'
